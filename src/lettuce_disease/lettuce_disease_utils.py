...
CLASS_NAMES = ['Bacterial', 'Downy_mildew_on_lettuce', 'Viral', 'Powdery_mildew_on_lettuce',
               'Wilt_and_leaf_blight_on_lettuce', 'Septoria_blight_on_lettuce']
...
def plot_training(history):
    os.makedirs('../../outputs/figures/lettuce_disease', exist_ok=True)
    ...
    plt.tight_layout()
    plt.savefig('../../outputs/figures/lettuce_disease/training_curve.png')
    plt.show()
...
def evaluate_model(model, test_gen, class_names):
    ...
    plt.savefig('../../outputs/figures/lettuce_disease/confusion_matrix.png')
    plt.show()